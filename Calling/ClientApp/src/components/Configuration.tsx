...
export const Configuration = (props: ConfigurationScreenProps): JSX.Element => {
    ...
    const [configToken, setConfigToken] = useState('Token');
    const [emptyWarningToken, setEmptyWarningToken] = useState(false);
            ...
            {props.deviceManager ? (
                ...
                >
                    ...
                    <Stack className={localSettingsContainerStyle}>
                        <DisplayNameField fieldName="Name" setName={setName} name={name} setEmptyWarning={setEmptyWarning} isEmpty={emptyWarning} warningMessage="Name cannot be empty" />
                        <DisplayNameField fieldName="Token" setName={setConfigToken} name={configToken} setEmptyWarning={setEmptyWarningToken} isEmpty={emptyWarningToken} warningMessage="Token value not correct" />
                        <div>
                            <LocalSettings
                                videoDeviceList={props.videoDeviceList}
                                audioDeviceList={props.audioDeviceList}
