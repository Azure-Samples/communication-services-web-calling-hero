...
Powering this front-end is a C# web application powered by ASP.NET Core to connect this application with Azure Communication Services. This sample includes [**Teams Interop**](https://docs.microsoft.com/azure/communication-services/concepts/teams-interop), which allows users to join an on going Teams meeting as a guest user. This functionality is in **Public Preview**.
